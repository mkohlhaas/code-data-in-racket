...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname letter-grade-error-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
