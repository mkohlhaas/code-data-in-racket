...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname arrange-images-v6) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; arrange-images-v4.rkt      (includes arrange-images, layout-images, sort, insert stub for larger?)
