...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname letter-grade-error-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
